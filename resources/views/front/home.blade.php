...
{{--        </svg>--}}
    <div id="course-list" class="course-wrapper-border parallax">
        <h1>Prehľad naších kurzov</h1>
        <div class="container">
            <course-list
                    @isset($courses)
                    :courses="{{$courses}}"
